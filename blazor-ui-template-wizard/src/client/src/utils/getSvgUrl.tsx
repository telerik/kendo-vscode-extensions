...
import blazorserver from "../assets/blazor_server.svg";
import blazorclient from "../assets/blazor_client.svg";
...
const SVG_MAPPINGS = {
  [WIZARD_CONTENT_INTERNAL_NAMES.BLAZOR_SERVER]: blazorserver,
  [WIZARD_CONTENT_INTERNAL_NAMES.BLAZOR_CLIENT]: blazorclient,
...
const SVG_REACTCOMPONENT_MAPPINGS = {
  ...
  [WIZARD_CONTENT_INTERNAL_NAMES.BLAZOR_SERVER_BLANK_PAGE]: (style: string) => (
    <BlankPage className={classnames(style, svgStyles.icon)} />
  ),
  [WIZARD_CONTENT_INTERNAL_NAMES.BLAZOR_SERVER_CHART_PAGE]: (style: string) => (
    <ChartPage className={classnames(style, svgStyles.icon)} />
  ),
  [WIZARD_CONTENT_INTERNAL_NAMES.BLAZOR_SERVER_FORM_PAGE]: (style: string) => (
    <FormPage className={classnames(style, svgStyles.icon)} />
  ),
  [WIZARD_CONTENT_INTERNAL_NAMES.BLAZOR_SERVER_HELLO_PAGE]: (style: string) => (
    <HelloPage className={classnames(style, svgStyles.icon)} />
  ),
  [WIZARD_CONTENT_INTERNAL_NAMES.BLAZOR_SERVER_GRID_PAGE]: (style: string) => (
    <GridPage className={classnames(style, svgStyles.icon)} />
  ),
  [WIZARD_CONTENT_INTERNAL_NAMES.BLAZOR_CLIENT_BLANK_PAGE]: (style: string) => (
    <BlankPage className={classnames(style, svgStyles.icon)} />
  ),
  [WIZARD_CONTENT_INTERNAL_NAMES.BLAZOR_CLIENT_CHART_PAGE]: (style: string) => (
    <ChartPage className={classnames(style, svgStyles.icon)} />
  ),
  [WIZARD_CONTENT_INTERNAL_NAMES.BLAZOR_CLIENT_FORM_PAGE]: (style: string) => (
    <FormPage className={classnames(style, svgStyles.icon)} />
  ),
  [WIZARD_CONTENT_INTERNAL_NAMES.BLAZOR_CLIENT_HELLO_PAGE]: (style: string) => (
    <HelloPage className={classnames(style, svgStyles.icon)} />
  ),
  [WIZARD_CONTENT_INTERNAL_NAMES.BLAZOR_CLIENT_GRID_PAGE]: (style: string) => (
    <GridPage className={classnames(style, svgStyles.icon)} />
  ),
...
const KENDO_MAPPINGS = {
  [WIZARD_CONTENT_INTERNAL_NAMES.BLAZOR_SERVER_BLANK_PAGE]: blankpage,
  [WIZARD_CONTENT_INTERNAL_NAMES.BLAZOR_CLIENT_BLANK_PAGE]: blankpage,
  [WIZARD_CONTENT_INTERNAL_NAMES.BLAZOR_SERVER_HELLO_PAGE]: hellopage,
  [WIZARD_CONTENT_INTERNAL_NAMES.BLAZOR_CLIENT_HELLO_PAGE]: hellopage,
  [WIZARD_CONTENT_INTERNAL_NAMES.BLAZOR_SERVER_GRID_PAGE]: gridpage,
  [WIZARD_CONTENT_INTERNAL_NAMES.BLAZOR_CLIENT_GRID_PAGE]: gridpage,
  [WIZARD_CONTENT_INTERNAL_NAMES.BLAZOR_SERVER_FORM_PAGE]: formpage,
  [WIZARD_CONTENT_INTERNAL_NAMES.BLAZOR_CLIENT_FORM_PAGE]: formpage,
  [WIZARD_CONTENT_INTERNAL_NAMES.BLAZOR_SERVER_CHART_PAGE]: chartpage,
  [WIZARD_CONTENT_INTERNAL_NAMES.BLAZOR_CLIENT_CHART_PAGE]: chartpage
}
