...
const ProjectSummary = (props: Props) => {
  const { selectedFrontend, projectName, pageCount, theme, license } = props;
  return (
    <div className={styles.container}>
      ...
      <table className={styles["info-table"]}>
        <tbody>
          ...
          <tr>
            <td><h4>Package Type</h4></td>
            <td className={styles["capitalize"]}>{license}</td>
          </tr>
          <tr>
            <td><h4>Pages</h4></td>
            <td>{pageCount}</td>
...
const mapStateToProps = (state: AppState): IStateProps => {
  ...
  return {
    ...
    license: state.selection.trial ? "Trial" : "Paid"
  };
};
