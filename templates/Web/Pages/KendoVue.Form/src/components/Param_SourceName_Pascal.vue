  ...
  <div class="container-fluid">
            ...
            <div class='row my-4'>
                ...
                <div class='col-12 col-lg-3 mt-3 mt-lg-0'>
                    <h3>KendoVue Forms</h3>
                    <p>KendoVue includes a wide offering of UI components that can be used to build forms, including CSS classes to easily create and structure gorgeous forms.</p>
                    <p>The required inputs get validated upon form submission and if the validation fails, the form submission is prevented. Out of the box, KendoVue delivers components which support the HTML5 form validation and also provide props for configuring a set of minimal requirements for a component to be in a valid state.</p>
                    <p>For documentation and demos of the many form-friendly components please visit their documentation (<a href="https://www.telerik.com/kendo-vue-ui/components/dateinputs/?utm_medium=cpm&utm_source=stackblitz-app&utm_campaign=kendo-ui-vue-trial-dateinputs">Date Inputs</a>, <a href="https://www.telerik.com/kendo-vue-ui/components/dropdowns/?utm_medium=cpm&utm_source=stackblitz-app&utm_campaign=kendo-ui-vue-trial-dropdowns">DropDowns</a>, <a href="https://www.telerik.com/kendo-vue-ui/components/inputs/?utm_medium=cpm&utm_source=stackblitz-app&utm_campaign=kendo-ui-vue-trial-inputs">Inputs</a> etc).</p>
                </div>
            </div>
        </div>
</template>
