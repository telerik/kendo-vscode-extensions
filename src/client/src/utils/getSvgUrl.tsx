...
const SVG_MAPPINGS = {
  ...
  [WIZARD_CONTENT_INTERNAL_NAMES.KENDO_VUE]: vue,
...
const SVG_REACTCOMPONENT_MAPPINGS = {
  ...
  [WIZARD_CONTENT_INTERNAL_NAMES.KENDO_VUE_BLANK_PAGE]: (style: string) => (
    <BlankPage className={classnames(style, svgStyles.icon)} />
  ),
  [WIZARD_CONTENT_INTERNAL_NAMES.KENDO_VUE_CHART_PAGE]: (style: string) => (
    <ChartPage className={classnames(style, svgStyles.icon)} />
  ),
  [WIZARD_CONTENT_INTERNAL_NAMES.KENDO_VUE_FORM_PAGE]: (style: string) => (
    <FormPage className={classnames(style, svgStyles.icon)} />
  ),
  [WIZARD_CONTENT_INTERNAL_NAMES.KENDO_VUE_HELLO_PAGE]: (style: string) => (
    <HelloPage className={classnames(style, svgStyles.icon)} />
  ),
  [WIZARD_CONTENT_INTERNAL_NAMES.KENDO_VUE_GRID_PAGE]: (style: string) => (
    <GridPage className={classnames(style, svgStyles.icon)} />
  ),
...
const KENDO_MAPPINGS = {
  ...
  [WIZARD_CONTENT_INTERNAL_NAMES.KENDO_VUE_BLANK_PAGE]: blankpage,
  ...
  [WIZARD_CONTENT_INTERNAL_NAMES.KENDO_VUE_HELLO_PAGE]: hellopage,
  ...
  [WIZARD_CONTENT_INTERNAL_NAMES.KENDO_VUE_GRID_PAGE]: gridpage,
  ...
  [WIZARD_CONTENT_INTERNAL_NAMES.KENDO_VUE_FORM_PAGE]: formpage,
  ...
  [WIZARD_CONTENT_INTERNAL_NAMES.KENDO_VUE_CHART_PAGE]: chartpage
}
